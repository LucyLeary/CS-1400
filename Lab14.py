...
def main():
    ...
    alien_rect.center = screen_size[0]//2, screen_size[1]//2
    ...
    while is_playing:  # while is_playing is True, repeat
        ...
        alien = aliens[int(frame_number) % 3]
...
# lecture showing how to move people around on screen
ball_rect = ball.get_rect()
ball_rects = []
for count in range(10):
    ball_pos = (random.randrange(0, width), random.randrange(0, height))
